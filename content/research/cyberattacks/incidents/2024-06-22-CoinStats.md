...
CoinStats also published a [Google Sheet of affected wallet addresses](https://docs.google.com/spreadsheets/d/1Lwxpy2T6W7aptjBJUio0Z01zihsqknXn6KPhzawQLVI/). The public list includes both Ethereum and Bitcoin addresses. Public reporting noted that the majority of the stolen funds appeared to be concentrated in a small number of wallets, but CoinStats did not publish a full official asset-by-asset breakdown in the incident report.
